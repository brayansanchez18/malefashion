  ...
  <div class="offcanvas-menu-wrapper">
    ...
    <div class="offcanvas__nav__option">
      <a href="#" class="search-switch"
        ><img src="<?=$backend?>vistas/img/icon/search.png" alt=""
      /></a>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-3">
          <div class="header__logo">
            <a href="./index.html"><img src="<?=$backend?>vistas/img/logo.png" alt="" /></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-3">
          <div class="header__nav__option">
            ...
            <a href="#"><img src="<?=$backend?>vistas/img/icon/heart.png" alt="" /></a>
            <a href="#"
              ><img src="<?=$backend?>vistas/img/icon/cart.png" alt="" /> <span>0</span></a
            >
            <div class="price">$0.00</div>
          </div>
        </div>
