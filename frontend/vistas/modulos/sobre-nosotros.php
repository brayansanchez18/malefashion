    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="about__pic">
          <img src="<?=$backend?>vistas/img/about/about-us.jpg" alt="" />
        </div>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="testimonial__text">
          ...
          <div class="testimonial__author">
            <div class="testimonial__author__pic">
              <img src="<?=$backend?>vistas/img/about/testimonial-author.jpg" alt="" />
            </div>
      ...
      <div class="col-lg-6 p-0">
        <div
          ...
          data-setbg="<?=$backend?>vistas/img/about/testimonial-pic.jpg"
        ></div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-1.png" alt=""
        /></a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-2.png" alt=""
        /></a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-3.png" alt=""
        /></a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-4.png" alt=""
        /></a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-5.png" alt=""
        /></a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-6.png" alt=""
        /></a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-7.png" alt=""
        /></a>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-4 col-6">
        <a href="#" class="client__item"
          ><img src="<?=$backend?>vistas/img/clients/client-8.png" alt=""
        /></a>
      </div>
    </div>
  </div>
