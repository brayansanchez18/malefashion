            ...
            <li class="nav-item">
              ...
              >
                <div
                  ...
                  data-setbg="<?=$backend?>vistas/img/shop-details/thumb-1.png"
                ></div>
              </a>
            </li>
            <li class="nav-item">
              ...
              >
                <div
                  class="product__thumb__pic set-bg"
                  data-setbg="<?=$backend?>vistas/img/shop-details/thumb-2.png"
                ></div>
              </a>
            </li>
            <li class="nav-item">
              ...
              >
                <div
                  class="product__thumb__pic set-bg"
                  data-setbg="<?=$backend?>vistas/img/shop-details/thumb-3.png"
                ></div>
              </a>
            </li>
            <li class="nav-item">
              ...
              >
                <div
                  class="product__thumb__pic set-bg"
                  data-setbg="<?=$backend?>vistas/img/shop-details/thumb-4.png"
                >
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tabs-1" role="tabpanel">
              <div class="product__details__pic__item">
                <img src="<?=$backend?>vistas/img/shop-details/product-big-2.png" alt="" />
              </div>
            </div>
            <div class="tab-pane" id="tabs-2" role="tabpanel">
              <div class="product__details__pic__item">
                <img src="<?=$backend?>vistas/img/shop-details/product-big-3.png" alt="" />
              </div>
            </div>
            <div class="tab-pane" id="tabs-3" role="tabpanel">
              <div class="product__details__pic__item">
                <img src="<?=$backend?>vistas/img/shop-details/product-big.png" alt="" />
              </div>
            </div>
            <div class="tab-pane" id="tabs-4" role="tabpanel">
              <div class="product__details__pic__item">
                <img src="<?=$backend?>vistas/img/shop-details/product-big-4.png" alt="" />
                <a
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
        <div class="product__item">
          <div
            ...
            data-setbg="<?=$backend?>vistas/img/product/product-1.jpg"
          >
            ...
            <ul class="product__hover">
              ...
              <li>
                <a href="#"
                  ><img src="<?=$backend?>vistas/img/icon/compare.png" alt="" />
                  <span>Compare</span></a
                >
              </li>
              <li>
                <a href="#"><img src="<?=$backend?>vistas/img/icon/search.png" alt="" /></a>
              </li>
            </ul>
          </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
        <div class="product__item">
          <div
            class="product__item__pic set-bg"
            data-setbg="<?=$backend?>vistas/img/product/product-2.jpg"
          >
            <ul class="product__hover">
              <li>
                <a href="#"><img src="<?=$backend?>vistas/img/icon/heart.png" alt="" /></a>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
        <div class="product__item sale">
          <div
            class="product__item__pic set-bg"
            data-setbg="<?=$backend?>vistas/img/product/product-3.jpg"
          >
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
        <div class="product__item">
          <div
            class="product__item__pic set-bg"
            data-setbg="<?=$backend?>vistas/img/product/product-4.jpg"
          >
            <ul class="product__hover">
              <li>
                <a href="#"><img src="<?=$backend?>vistas/img/icon/heart.png" alt="" /></a>
